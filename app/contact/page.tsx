      ...
      <main className="flex-grow max-w-container-max mx-auto w-full px-md md:px-lg py-lg md:py-xl relative">
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-lg md:gap-xl items-start relative z-10">
          ...
          <div className="lg:col-span-2 flex flex-col gap-lg">
            <div>
              <p className="font-label-bold text-label-bold text-primary uppercase tracking-[0.14em] text-[12px] mb-sm">Contact</p>
            ...
            <div className="flex flex-col gap-md">
              <div className="contact-info-row flex items-start gap-md">
                ...
                <div>
                  ...
                  <a href="mailto:info@alubonets.com" className="font-body-md text-[15px] text-on-surface-variant hover:text-primary transition-colors">
                    info@alubonets.com
                  </a>
                </div>
              </div>
              ...
              <div className="contact-info-row flex items-start gap-md">
                ...
                <div>
                  ...
                  <p className="font-body-md text-[15px] text-on-surface-variant">Butere, Kakamega County, Kenya</p>
                </div>
              </div>
            </div>
          </div>
              ...
              <form className="flex flex-col gap-md">
                <div>
                  <div className="contact-section-label mb-sm">
                    <span className="font-label-bold text-label-bold text-primary uppercase tracking-[0.14em] text-[12px]">Your Information</span>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-md">
                    <div className="flex flex-col gap-xs">
                      ...
                      <div className="contact-input-wrap">
                        <input className="contact-field-modern font-body-md text-[16px] text-on-surface" id="name" name="name" placeholder="Jane Doe" type="text" required />
                        <span className="material-symbols-outlined contact-input-icon text-[18px]">person</span>
                      </div>
                    </div>
                    <div className="flex flex-col gap-xs">
                      ...
                      <div className="contact-input-wrap">
                        <input className="contact-field-modern font-body-md text-[16px] text-on-surface" id="phone" name="phone" placeholder="+254 7** *** ***" type="tel" required />
                        <span className="material-symbols-outlined contact-input-icon text-[18px]">call</span>
                      </div>
                    </div>
                  </div>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-md mt-md">
                    <div className="flex flex-col gap-xs">
                      ...
                      <div className="contact-input-wrap">
                        <input className="contact-field-modern font-body-md text-[16px] text-on-surface" id="email" name="email" placeholder="jane@example.com" type="email" required />
                        <span className="material-symbols-outlined contact-input-icon text-[18px]">mail</span>
                      </div>
                    </div>
                    <div className="flex flex-col gap-xs">
                      <label className="font-label-bold text-[15px] text-on-surface" htmlFor="category">Category</label>
                      <div className="contact-input-wrap">
                        <select className="contact-select-modern font-body-md text-[16px] text-on-surface" id="category" name="category">
                        ...
                        <span className="material-symbols-outlined contact-input-icon text-[18px]">expand_more</span>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div>
                  <div className="contact-section-label mb-sm">
                    <span className="font-label-bold text-label-bold text-primary uppercase tracking-[0.14em] text-[12px]">Message Details</span>
                    <span className="contact-section-accent" aria-hidden="true" />
                  </div>
                  <div className="flex flex-col gap-xs">
                    ...
                    <div className="contact-input-wrap items-start">
                      <textarea
                        ...
                        required
                      />
                      <span className="material-symbols-outlined contact-input-icon text-[18px]">edit_note</span>
                    </div>
                  </div>
                </div>
